...
class TimingResolver:
    ...
    def resolve(self, fps: float = None, frames: int = None, duration: float = None, authority: str = None) -> dict:
        ...
        self.logger.info(
            f"[Timing] authority={authority} | fps={initial_fps}, frames={initial_frames}, duration={initial_duration}"
        )
        ...
        self.logger.info(
            f"[Timing] resolved: fps={resolved_fps}, frames={resolved_frames}, duration={resolved_duration:.3f}"
        )
