...
def _aspect_ratio_from_dims(width: int, height: int) -> str:
    ...
    NOTE (aspect-ratio fix): prior versions returned the GCD-reduced ratio
...
class VeniceConfig:
    ...
    def from_dict(cls, d: Dict[str, Any]) -> "VeniceConfig":
        ...
        if image:
            ...
            # aspect_ratio for /image/edit and resolution for parity.
...
class VeniceBackend(GeneratorBackend):
    ...
    def _queue_video_request(self, queue_payload: Dict[str, Any]) -> Tuple[Dict[str, Any], Dict[str, Any], List[str]]:
        ...
        # Defence-in-depth — the request-builder already snaps
        ...
        while True:
            ...
            if response.status_code == 400:
                ...
                # Same logic as duration / resolution: when
